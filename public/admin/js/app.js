...
(function (global, factory) {
  ...
  function modifierValue(modifiers, key, fallback) {
    ...
    if (key === 'scale') {
      ...
      // That is how a users opts out of the opacity transition.
  ...
  function transitionHelper(el, modifiers, hook1, hook2, reject, styleValues, type) {
    ...
    } // If the users set these style values, we'll put them back when we're done with them.
  ...
  function isListeningForASpecificKeyThatHasntBeenPressed(e, modifiers) {
    ...
    if (keyModifiers.length === 1 && keyModifiers[0] === keyToModifier(e.key)) return false; // The users is listening for key combinations.
  ...
  function lockShadowTarget(membrane, shadowTarget, originalTarget) {
      ...
      targetKeys.forEach((key) => {
          ...
          // Because we can deal with wrapping it when users goes through
  ...
  class Component {
    constructor(el, componentForClone = null) {
      ...
      this.$data = data;
      this.membrane = membrane; // After making users-supplied data methods reactive, we can now add
      ...
      if (typeof initReturnedCallback === 'function') {
        // Run the callback returned from the "x-init" hook to allow the users to do stuff after
